    ...
    var body: some View {
        NavigationView {
            VStack(spacing: 15) {
                ...
                Text("Enter A keyword Below Ex: cat")
                    .fontWeight(.bold)
                ...
                Text("Enter the plaintext/ciphertext below")
                    .fontWeight(.bold)
                Text("For propper encrytion it will clean the text. Example: You're -> youre")
                    .font(.caption)
                ...
                HStack {
                    ...
                    Button(action: {
                        ...
                        ciphertext = vigenereEncode.encrypt(plainText: plaintext, key: keyWord)
                    ...
                    //plaintext represents the ciphertext in this context
                    Button(action: {
                        let vigenere = vigenereEncode.decrypt(cipherText: plaintext, key: keyWord)
                        plaintext = vigenere
                        decryptSheet = true
                    })
                    {
            ...
            .navigationTitle(Text("Vigenère Cipher"))
            .toolbar {
